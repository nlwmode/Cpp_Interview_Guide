...
11. [含有虚函数的类的 sizeof 的大小](https://www.cnblogs.com/younes/archive/2010/06/07/1753488.html)
...
12. [struct字节对齐规则](https://www.cnblogs.com/yichi/p/9478004.html)
...
13. [指针和引用的区别](https://www.cnblogs.com/yuanqiangfei/p/11248160.html)
   1. 指针是实体，引用是别名，没有空间。
   2. 引用定义时必须初始化，指针不用。
   3. 指针可以改，引用不可以。
   4. 引用不能为空，指针可以。
...
14. [static 关键字 、静态变量、静态方法](https://www.cnblogs.com/swisszhang/p/9892992.html)
...
15. [const与define的比较](https://blog.csdn.net/qq_41804181/article/details/82714026)
...
16. [顶层const、底层const](https://blog.csdn.net/qq_19528953/article/details/50922303)
    针对指针，分为顶层和底层。
...
15. [C++ 4种类型转换](http://blog.sina.cn/dpool/blog/s/blog_94a1fe540102yoaj.html)
...
16. [C++ new、malloc](https://www.cnblogs.com/avril/p/3175175.html)
...
17. [进程的地址空间内存分配](https://blog.csdn.net/cl_linux/article/details/80328608)
   程序段
   初始化过的数据(Data)
   未初始化过的数据(BSS)
   栈
   堆
18. [深拷贝与浅拷贝](https://blog.csdn.net/weixin_41143631/article/details/81486817)
    会调用拷贝构造函数的场景：
         1. 一个对象以值传递的方式传入函数体；
         2. 一个对象以值传递的方式从函数返回；
...
19. [静态函数不能定义为虚函数与常函数](https://www.cnblogs.com/lakeone/p/5967548.html)
